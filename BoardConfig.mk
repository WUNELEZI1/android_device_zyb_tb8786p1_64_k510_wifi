...
BOARD_BOOTLOADER_HEADER_VERSION := 4  # 匹配解包header v4
...
BOARD_MKBOOTIMG_ARGS := \
    ...
    --ramdisk_type gzip  # 匹配解包的ramdisk gzip格式

# vendor_boot专属配置（匹配解包的raw格式+dtb大小）
BOARD_VENDOR_BOOT_RAMDISK_TYPE := raw
BOARD_VENDOR_BOOT_DTB_SIZE := 159397  # 严格匹配解包的DTB_SZ=159397
BOARD_VENDOR_BOOT_PAGESIZE := 4096  # 匹配解包的PAGESIZE=4096
...
BOARD_USES_RECOVERY_AS_BOOT := false  # 单独构建vendor_boot
...
TW_NO_SPLASH := true
TW_BUILD_VENDOR_BOOT := true  # 强制生成vendor_boot

# 匹配解包的OS版本和安全补丁
PLATFORM_SECURITY_PATCH := 2024-09-05
VENDOR_SECURITY_PATCH := 2024-09-05
PLATFORM_VERSION := 12.0.0  # 匹配解包OS_VERSION=12.0.0
